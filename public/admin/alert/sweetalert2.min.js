!(function(t, e) {
    ...
    function ft(t) {
        wn.isVisible() && gt !== t.target.value && wn.resetValidationMessage(),
            (gt = t.target.value);
    }
    function mt(t, e) {
        ...
        kt = function(t) {
            ...
            pt()
                ...
                : (((n = document.createElement("div")).className =
                  ...
                  (s = o),
                  "rtl" === window.getComputedStyle(s).direction &&
                      vt(C(), J.rtl),
                  (c = P()),
                  (u = bt(c, J.input)),
                  (l = bt(c, J.file)),
    ...
    function Vt(t, e) {
        var n,
            ...
            r,
            a,
            s = P().querySelector("#".concat(J.content));
        e.html
            ...
            (o = e),
            (i = P()),
            (r = Tt.innerParams.get(n)),
            (a = !r || o.input !== r.input),
            Lt.forEach(function(t) {
                var e = J[t],
                    n = bt(i, e);
                qt(t, o.inputAttributes), (n.className = e), a && at(n);
            }),
            o.input && (a && Dt(o), jt(o)),
            z(P(), e, "content");
    }
    ...
    function Ht(t, c) {
        ...
        rt(u), (u.textContent = "");
        var l = parseInt(
            void 0 === c.currentProgressStep ? Rt() : c.currentProgressStep
        );
    ...
    function Nt(t, e) {
        ...
        z(l, e, "header"),
            ...
            (n = t),
            (o = e),
            (r = Tt.innerParams.get(n)) && o.icon === r.icon && B()
                ? zt(B(), o)
                : (Ft(),
                  o.icon &&
        ...
        Kt = function(t, e) {
            (t.textContent = ""),
                e.iconHtml
                    ...
                    : _(
                          t,
                          Zt({ question: "?", warning: "!", info: "i" }[e.icon])
                      );
        },
        Yt = function(t, e) {
            if (e.iconColor) {
    ...
    function oe(t) {
        for (var e in t)
            ee((i = e)) || K('Unknown parameter "'.concat(i, '"')),
                t.toast &&
                    ((o = e),
                    -1 !== ce.indexOf(o) &&
                        K(
    ...
    var me = function() {
        ...
        ve = { swalPromiseResolve: new WeakMap() };
    function ye(t, e, n, o) {
        var i;
        n
            ? ke(t, o)
    ...
    function be(t) {
        ...
        i &&
            ...
            (e = Tt.innerParams.get(this)) &&
                ...
                ((n = ve.swalPromiseResolve.get(this)),
    ...
    var we = function(t, e, n) {
        ...
        Ce = function(t, e, n, o) {
            (ie.swalCloseEventFinishedCallback = ye.bind(null, t, n, G(), o)),
    ...
    function Le(t, e) {
        t.disableButtons(), e.input ? Qe(t, e) : Je(t, e, !0);
    }
    function De(t) {
        t.disableButtons(), $e(t);
    }
    function qe(t, e) {
    ...
    function Ve(t, e, n) {
        Tt.innerParams.get(t).toast ? sn(t, e, n) : (un(e), ln(e), dn(t, e, n));
    }
    var Re = function(t, e) {
        ...
        Ne = function(t, e, n) {
            ...
            ((/iPad|iPhone|iPod/.test(navigator.userAgent) &&
                ...
                "undefined" != typeof window &&
                    pe() &&
                    (fe(), window.addEventListener("resize", fe)),
                e && "hidden" !== n && de(),
                setTimeout(function() {
                    t.scrollTop = 0;
                });
                ...
                ? (e.disableInput(),
                  Promise.resolve()
                      ...
                      .then(function(t) {
                          e.enableButtons(),
                              e.enableInput(),
                              t ? e.showValidationMessage(t) : Je(e, n, o);
                      }))
        ...
        en = function(t, e, n) {
            ...
            o.stopKeydownPropagation && e.stopPropagation(),
                "Enter" === e.key
                    ...
                    : "Tab" === e.key
                    ? on(e, o)
                    : -1 !== [].concat(Xe, Ge).indexOf(e.key)
                    ? rn(e.key)
                    : -1 !== tn.indexOf(e.key) && an(e, o, n);
        },
        nn = function(t, e, n) {
            if (
                !e.isComposing &&
    ...
    var pn = function(t, e, n) {
        ...
        fn = function(t, e) {
            if (!e.toast)
                return Q(e.allowEnterKey)
                    ? void (mn(t, e) || Me(0, -1, 1))
                    : hn();
        },
        mn = function(t, e) {
    ...
    var gn,
        ...
        yn = Object.freeze({
            ...
            enableButtons: function() {
                xe(this, ["confirmButton", "denyButton", "cancelButton"], !1);
            },
            disableButtons: function() {
                xe(this, ["confirmButton", "denyButton", "cancelButton"], !0);
            },
            ...
            _main: function(t) {
                ...
                var e = (function(t) {
                    var e = c({}, re.showClass, t.showClass),
                        n = c({}, re.hideClass, t.hideClass),
                        o = c({}, re, t);
                    if (
                        ((o.showClass = e),
                        (o.hideClass = n),
