        ...
        (function(a) {
            function e(b, c) {
                ...
                if (
                    ...
                    (this.touchX = 0),
                    (this.touchY = 0),
                    (this.tooltip = this.sliderElem.querySelector(
                        ".tooltip-main"
                    )),
                    (this.tooltipInner = this.tooltip.querySelector(
                        ".tooltip-inner"
                    )),
                    (this.tooltip_min = this.sliderElem.querySelector(
                        ".tooltip-min"
                    )),
                    (this.tooltipInner_min = this.tooltip_min.querySelector(
                        ".tooltip-inner"
                    )),
                    (this.tooltip_max = this.sliderElem.querySelector(
                        ".tooltip-max"
                    )),
                                ...
                                for (
                                    ...
                                    if (a <= this.options.ticks_positions[i]) {
                                        (d = this.options.ticks[i - 1]),
                                            (f = this.options.ticks_positions[
                                                i - 1
                                            ]),
                                            (e = this.options.ticks[i]),
                                            (g = this.options.ticks_positions[
                                                i
                                            ]);
                                        break;
                                    }
                                ...
                                for (
                                    ...
                                    if (a <= this.options.ticks[f]) {
                                        (b =
                                            ...
                                            (e = this.options.ticks_positions[
                                                f
                                            ]);
                                        break;
                                    }
