    ...
    (function($) {
        ...
        var generateOption = {
            ...
            text: function(options, useFragment) {
                ...
                if (options.content) {
                    ...
                    if (options.icon) {
                        var whitespace = elementTemplates.whitespace.cloneNode(
                            false
                        );
                    ...
                    if (options.subtext) {
                        subtextElement = elementTemplates.subtext.cloneNode(
                            false
                        );
        ...
        Selectpicker.prototype = {
                    ...
                    this.$element.on("hide" + EVENT_KEY, function() {
                        if (that.isVirtual()) {
                            ...
                            var menuInner = that.$menuInner[0],
                                emptyMenu = menuInner.firstChild.cloneNode(
                                    false
                                );
            ...
            setPlaceholder: function() {
                ...
                if (this.options.title && !this.multiple) {
                    ...
                    var element = this.$element[0],
                        isSelected = false,
                        titleNotAppended = !this.selectpicker.view.titleOption
                            .parentNode;
                            ...
                            for (
                                ...
                                if (selectedIndex < 50) {
                                    var option = selectedOptions[selectedIndex],
                                        thisData = this.selectpicker.main.data[
                                            option.liIndex
                                        ],
                                        titleOptions = {};
            ...
            liHeight: function(refresh) {
                ...
                this.sizeInfo.menuInnerInnerWidth =
                    menuWidth - menuPadding.horiz;
            ...
            setSelected: function(index, selected) {
                ...
                if (
                    ...
                    prevActive = this.selectpicker.main.elements[
            ...
            if (!version.success) {
                ...
                try {
                    ...
                    if (Selectpicker.BootstrapVersion) {
                        version.full = Selectpicker.BootstrapVersion.split(
                            " "
                        )[0].split(".");
                    } else {
